...
//                }
//
//                public int InstallEventHandler(Pointer pointer, EventHandlerProcPtr eventHandlerProcPtr, int i, EventTypeSpec[] eventTypeSpecs, Pointer pointer1, PointerByReference pointerByReference) {
//                    return 0;
//                }
//
//                public int RegisterEventHotKey(int i, int i1, EventHotKeyID.ByValue byValue, Pointer pointer, int i2, PointerByReference pointerByReference) {
//                    return 0;
//                }
//
//                public int GetEventParameter(Pointer pointer, int i, int i1, Pointer pointer1, int i2, IntBuffer intBuffer, EventHotKeyID eventHotKeyID) {
//                    return 0;
//                }
//
//                public int RemoveEventHandler(Pointer pointer) {
//                    return 0;
//                }
//
//                public int UnregisterEventHotKey(Pointer pointer) {
//                    return 0;
//                }
